                            ...
                            <!-- inner menu: contains the actual data -->
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="<?= base_url('front-end/img/user4-128x128.jpg') ?>" class="img-circle" alt="User Image">
                                            </div>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="<?= base_url('front-end/img/user5-128x128.jpg') ?>" class="img-circle" alt="User Image">
                                            </div>
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="menu">
                                        ...
                                        <li><!-- Task item -->
                                            <a href="#">
                                                <h3>Make beautiful transitions<small class="pull-right">80%</small>
                                                </h3>
                                                <div class="progress xs">
